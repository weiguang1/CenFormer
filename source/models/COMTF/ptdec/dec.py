...
class DEC(nn.Module):
    ...
    def loss(self, assignment):
        # clamp: softmax assignments can underflow to exactly 0, and
        # log(0)/empty-cluster divisions NaN the whole training run
        flattened_assignment = assignment.view(-1, assignment.size(-1)).clamp(min=1e-8)
